function [out1,out2] = OnceNewrb_EPOS(varargin)
% Radial basis network without iterative optimization for EPOS
...
function [net,tr] = create_network(param)
  ...
  [w1,b1,w2,b2,tr] = designrb_with_kmeans(p,t,param.goal,param.spread,mn,param.displayFreq); % CHANGEnsh
...
%======================================================
function [w1,b1,w2,b2,tr] = designrb_with_kmeans(p,t,eg,sp,mn,df) % CHANGEnsh

  % clurstering
  [idx,w1] = kmeans(p', mn);    % w1: center
